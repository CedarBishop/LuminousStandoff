Shader "Custom/Water"
{
	Properties
	{
		...
		_FoamMaxDistanceDistance("Foam Maximum Distance", Float) = 0.4
		_FoamMinDistance("Foam Minimum Distance", Float) = 0.14
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			// Blends two colors using the same algorith that our shader is using to blend with the screen.
            ...
            float4 frag (v2f i) : SV_Target
            {
				...
				// Calculate the color of the water based on teh depth using our two gradient colors
				...
				// Modulate between the amount of foam we display based on the difference between the normals of our water surface and the object behind it.
				...
				float2 noiseUV = float2(
					(i.noiseUV.x + _Time.y * _SurfaceNoiseScroll.x),
				...
				// Uncomment the line below to see how it looks without anti-aliasing
				...
				// Use normal alpha blending to combine the doam with the surface
